...
pull the github profiles, and other coding profiles
once pulled, get people from same city together
then u need to apply machine learning algorithms which work on data similarity
...
pull data once in 24 hours for each profile
like once you sign up, get the time at that moment
then every 24 hours for that profile only, need to pull data
